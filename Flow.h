...
/*
1) O que estou tentando maximizar/minimizar?
...
vector<pair<int, int>> get_cut(dinitz& g, int s, int t) {
	...
	int k = g.g.size();
	for (int i = 0; i < k; i++) for (auto e : g.g[i])
